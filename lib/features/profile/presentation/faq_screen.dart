...
class FaqScreen extends StatelessWidget {
  ...
  static const _items = [
    ...
    _FaqItem(
      ...
      answer:
          'QPay QR код эсвэл банкны шилжүүлгээр төлбөр төлнө. Банкны шилжүүлгийн тохиолдолд админ баталгаажуулах хугацаа шаардлагатай. Төлбөр амжилттай болсны дараа захиалга идэвхжинэ.',
    ),
    _FaqItem(
