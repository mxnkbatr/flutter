...
class LegalDocumentScreen extends StatelessWidget {
  ...
  static const _termsSections = [
    ...
    '3. Захиалга ба төлбөр\nЗахиалга үүсгэсний дараа QPay-ээр төлбөр төлнө. Төлбөр амжилттай болмогц захиалга автоматаар баталгаажина (лам тусад нь батлах шаардлагагүй). Буцаалтын нөхцөл QPay-ийн дүрмээр зохицуулагдана.',
