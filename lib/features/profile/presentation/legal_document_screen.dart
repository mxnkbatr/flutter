...
class LegalDocumentScreen extends StatelessWidget {
  ...
  static const _termsSections = [
    ...
    '3. Захиалга ба төлбөр\nЗахиалга лам баталгаажуулсны дараа QPay-ээр төлбөр төлөгдөнө. Төлбөр амжилттай болсны дараа захиалга идэвхжинэ. Буцаалтын нөхцөл QPay-ийн дүрмээр зохицуулагдана.',
